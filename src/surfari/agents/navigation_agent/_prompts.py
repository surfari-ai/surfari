...
- History of all previous turns is always provided. If you need to remember something for future turns, explicitly write it into the "reasoning" field of your response.
---
